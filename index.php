    ...
    <body>
        <div class="jumbotron text-center">
         ...
         <form action="controller/controllerIMC.php">
                <input type="hidden" name="opcion" value="calcular" />
                <label>Peso(kg):</label><input type="number" step="0.01" name="peso" value="74" required="" pattern="Ingrese su peso en kg"/>
                <label>Altura(mtrs):</label><input type="number" name="altura" step="0.01" required="" value="1.68" patern="Ingrese su altura en metros" /><p></p>
                <center><button class="btn btn-primary" >CALCULAR IMC  </button></center>
              
            </form>
        </div>
    
        <form action="model/ModelIMC.php">
